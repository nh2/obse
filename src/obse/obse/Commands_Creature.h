...
extern CommandInfo kCommandInfo_GetCreatureSound;
extern CommandInfo kCommandInfo_ToggleCreatureModel;

extern CommandInfo kCommandInfo_GetCreatureModelPaths;
